...
export const config = {
  ...
  savedVideoCollectionId: "6758217700045d670577",
...
export const uploadFile = async (file, type) => {
  ...
  try {
    ...
    console.log("Error from upload file function: ",error);
    throw new Error(error);
  }
};
...
export const getSavedPosts = async () => {
  try {
    const posts = await databases.listDocuments(databaseId, savedVideoCollectionId, [
      Query.orderDesc("$createdAt"),
    ]);
    return posts.documents;
  } catch (error) {
